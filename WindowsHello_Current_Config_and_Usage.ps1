...
Function Main 
 ...
 #   $OSInfo 
   ...
   # $User_used_Convenience_PIN 
    ...
    $UserInfo | Add-Member -Name 'Biometrics_ResultText'  -MemberType Noteproperty -Value $($exitmessage)
    $UserInfo | Add-Member -Name 'Biometrics_ResultCode'  -MemberType Noteproperty -Value $exitcode
...
$UserInfo = Main
#                        0, 1, 2, ...                    0, 10, 20, 30, ..
$exitcode = $UserInfo.Biometrics_ResultCode + $UserInfo.PIN_ResultCode
